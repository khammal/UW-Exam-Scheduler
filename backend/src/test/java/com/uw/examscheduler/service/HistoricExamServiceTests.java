package com.uw.examscheduler.service;

import com.uw.examscheduler.exam.model.HistoricExam;
import com.uw.examscheduler.exam.repo.HistoricExamRepository;
import com.uw.examscheduler.exam.service.HistoricExamService;
...
public class HistoricExamServiceTests {
    ...
    public void testGetExamsByNameAndYear() {
        ...
        List<String> years = Arrays.asList(("W2025"));
        ...
        assertEquals("W2025", result.get(0).getYear());
