package com.uw.examscheduler.repository;

import com.uw.examscheduler.exam.model.Exam;
import com.uw.examscheduler.exam.repo.ExamRepository;
...
public class ExamTests {
    ...
    public void testGetExam() {
        ...
        assertEquals(LocalDateTime.of(2025, 4, 19, 10, 0), exam.getexam_start_time());
        assertEquals(LocalDateTime.of(2025, 4, 19, 13, 0), exam.getexam_end_time());
