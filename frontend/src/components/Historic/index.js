...
const Historic = () => {
  ...
  const [selectedYears, setSelectedYears] = useState(["w2025", "f2024", "w2024", "f2023"]);
  const isMobileView = window.innerWidth <= 1150;

  const yearOptions = [
    { label: "W2025", value: "w2025" },
  ...
  const handleGoButtonClick = () => {
    ...
    setTimeout(() => {
      window.location.href = `/historic?names=${encodeURIComponent(searchQuery)}&years=${encodeURIComponent(selectedYearsString)}`;
    }, 1);
  };
    ...
    <div className="container data-page">
      <div className="text-zone">
        ...
        {examData.length === 0 ? (
          ...
          <div className="table-container table-transform">
          <table>
            <thead>
              <tr>
                {isMobileView ? (
